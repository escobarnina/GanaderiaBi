-- Script básico para crear la base de datos GanaderiaBi
...
-- Insertar datos de prueba para logos
...
SELECT '✅ Base de datos GanaderiaBi creada exitosamente' as mensaje; 